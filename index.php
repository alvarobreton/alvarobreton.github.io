...
<div class="banner">
	<div class="container">
		<div class="col-md-3 b-part1">
			<img src="https://pbs.twimg.com/profile_images/1050407543065825280/S5WvBfvl_400x400.jpg" alt=" " />
			<h1>Álvaro Lima</h1>
			<h2>Web developer</h2>
		</div>
		<div class="col-md-3 b-part2">
			<h3>Contacto</h3>
			<h4><a href="mailto:alvaro@limagiron.com">alvaro@limagiron.com</a></h4>
			<h4 class="agile">+52 553 886 16 65</h4>
			<h4>CDMX, México</h4>
		</div>
		<div class="col-md-3 b-part3">
			<h3>Sigueme</h3>
			<a href="https://www.linkedin.com/in/limagirondotcom/"  target=”_blank” ><i class="fa fa-linkedin" aria-hidden="true"></i></a>
			<a href="https://www.instagram.com/limagirondotcom/"  target=”_blank” ><i class="fa fa-instagram" aria-hidden="true"></i></a>
			<a href="https://twitter.com/limagirondotcom"  target=”_blank” ><i class="fa fa-twitter" aria-hidden="true"></i></a>
...
<div class="about">
	<div class="container">
		...
		<img src="https://pbs.twimg.com/profile_images/1050407543065825280/S5WvBfvl_400x400.jpg" alt=" " />
		<p>Soy Álvaro Lima, actualmente estoy ejerciendo mis conocimientos de ingeniería en el ámbito financiero en la Prevención de Lavado de Dinero y Financiamiento al Terrorismo (PLD/FT). Mis otras actividades es seguir enriqueciéndome en las nuevas tecnológicas (TI) como cursos, diplomados, libros, etc. </p>
		<p>Hablando en deportes me gusta el senderismo en montaña y correr (Récord 12 Kilómetros y 8 Kilómetros diarios) actualmente es ocasional.</p>
		<p>Me gusta el cine, jugar ajedrez y las tardes de café.</p>
		<p>“El café ayuda a quien duerme poco y sueña mucho” (Anónimo,2019)</p>
	</div>
</div>
<!--//about-->
		...
		<label class="line"></label>
			...
			<div class="col-md-6 skills-right">
				<div class="bar_group">
					...
					<div class='bar_group__bar thin' label='JavaScript' show_values='true' tooltip='true' value='90'></div>
					<div class='bar_group__bar thin' label='PHP' show_values='true' tooltip='true' value='97'></div>
					<div class='bar_group__bar thin' label='JAVA' show_values='true' tooltip='true' value='75'></div>
					<div class='bar_group__bar thin' label='git' show_values='true' tooltip='true' value='80'></div>
				</div>
			</div>
			<div class="col-md-6 skills-right">
				<div class="bar_group">
					<div class='bar_group__bar thin' label='UNIX/linux' show_values='true' tooltip='true' value='90'></div>
					<div class='bar_group__bar thin' label='Google Cloud' show_values='true' tooltip='true' value='78'></div>
					<div class='bar_group__bar thin' label='Microsoft Azure' show_values='true' tooltip='true' value='75'></div>
					<div class='bar_group__bar thin' label='node.js' show_values='true' tooltip='true' value='70'></div>
					<div class='bar_group__bar thin' label='CCS3' show_values='true' tooltip='true' value='70'></div>
				</div>
...
<!-- download-->
<div class="download">
	<h3>Contáctame vía correo.</h3>
	<a href="mailto:alvaro@limagiron.com">Contactar</a>
</div>
<!-- //download -->
...
<!-- blog -->
	<div class="download">
		<div class="container">
			<h4>¿Hay que tener inteligencia para jugar? No, el Ajedrez hace a la gente inteligente.</h4>
			<small> (Emanuel Lasker, ex campeón del mundo)</small>
			<label class="line"></label>
			<?php /*<h3>Seminars</h3>
			<label class="line"></label>
...
<div class="contact">
	<div class="container">
		...
		<div class="col-md-4 c-w3l c-phn">
			...
			<h4>+52 553 886 16 65</h4>
		</div>
		<div class="clearfix"></div>
		<form action="#" method="post">
			<input type="text" name="name" class="name" placeholder="Nombre" required="">
			<input type="text" name="email" class="email" placeholder="Correo" required="">
			<textarea  name="your message" placeholder="Mensaje"  required=""></textarea>
